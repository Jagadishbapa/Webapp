...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."UW_ENGAGEMENT" 
   (	"EVENT_ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"PRIVATE" VARCHAR2(3 BYTE) DEFAULT 'NO', 
	"FEE" NUMBER DEFAULT 0, 
	"EVENT_START_DATE_TIME" TIMESTAMP (6), 
	"EVENT_END_DATE_TIME" TIMESTAMP (6), 
	"EVENT_COST" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" 
 LOB ("EVENT_FILE") STORE AS BASICFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Index UW_ENGAGEMENT_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UW_ENGAGEMENT_PK" ON "SYSTEM"."UW_ENGAGEMENT" ("EVENT_ID") 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Trigger UW_ENGAGEMENT_TRIGGER
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."UW_ENGAGEMENT_TRIGGER" 
...
END;
/
ALTER TRIGGER "SYSTEM"."UW_ENGAGEMENT_TRIGGER" ENABLE;
--------------------------------------------------------
--  Constraints for Table UW_ENGAGEMENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("EVENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("ORGANIZATION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("DEPARTMENT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("EVENT_DESC" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("EVENT_TYPE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("PRIVATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("FEE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("EVENT_START_DATE_TIME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("EVENT_END_DATE_TIME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" MODIFY ("CREATION_DATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_PK" PRIMARY KEY ("EVENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK1" CHECK (organization IN(
...
'University Operations'
  ...
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK2" CHECK (department IN (
'A&S Computer Fee',
'A&S Dean''s Office',
'A&S Natural Science',
...
'Zoology & Physiology'
  ...
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK3" CHECK (event_type IN (
...
'Seminar/Public talk or Performance/Exhibition'
  ...
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK4" CHECK (private IN (
'YES', 'NO'
)) ENABLE;
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK5" CHECK (funding_source1 IN (
'Federal grants',
...
'UW Foundation and other gifts'
  ...
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK6" CHECK (funding_source2 IN (
'Federal grants',
'Special Appropriations (legislative)',
'State grants and other non-federal grants',
'Student Fees',
...
'UW Foundation and other gifts'
  ...
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK7" CHECK (cancelled IN (
'YES', 'NO'
)) ENABLE;
  ALTER TABLE "SYSTEM"."UW_ENGAGEMENT" ADD CONSTRAINT "UW_ENGAGEMENT_CHK8" CHECK (event_start_date_time < event_end_date_time) ENABLE;
