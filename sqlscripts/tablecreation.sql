...
'YES', 'NO'
	 ...
	 CONSTRAINT "UW_ENGAGEMENT_CHK8" CHECK ((location.address_line1 IS NOT NULL AND 
...
'Wyoming'
 ...
 location.country in ('United States')
	 ...
	 CONSTRAINT "UW_ENGAGEMENT_CHK9" CHECK ((contact_info.Sponsoring_department IS NOT NULL AND contact_info.email_1 IS NOT NULL)
 ) ENABLE, 
...
CREATE OR REPLACE TRIGGER UW_ENGAGE_CANCELU_TRIGGER 
